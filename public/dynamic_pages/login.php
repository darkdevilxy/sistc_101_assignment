...
<div class="donation_card_container">
    <form method="post" class="donation_form" action="../dynamic_pages/admin_page.php">
...
<script>
    ...
    function buttonclick() {
        var data = getValues();
        if (data.username == "bibek" && data.password == "1234") {
            window.location.href = "../dynamic_pages/admin_page.php";
        } else {
            alert("Login Failed");
        }
    }
